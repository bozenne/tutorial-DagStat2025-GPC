...
print(BuyseTest(Group~c(StdDiffCount, threshold=0.2)+c(DiffQoL), data=EB,method.inference="studentized permutation",n.resampling=10000))
##     endpoint threshold total(%) favorable(%) unfavorable(%) neutral(%) uninf(%)  delta  Delta  p.value
## StdDiffCount       0.2      100        56.44          19.56      17.33     6.67 0.3689 0.3689 0.053795
##      DiffQoL                 24        15.11           2.67       3.56     2.67 0.1244 0.4933 0.016798
